# ！/usr/bin/env python
# -*- coding:utf-8 -*-
# authot: Mr.Song  time:2021/10/29
import os
import torch
...
parser.add_argument('--root_path', type=str,
                    default='./datasets/Coronary', help='root dir for data') # ../data/Synapse/train_npz
parser.add_argument('--dataset', type=str,
                    default='Coronary', help='experiment_name') # Synapse
parser.add_argument('--list_dir', type=str,
                    default='./lists/lists_Coronary', help='list dir') # ./lists/lists_Synapse
parser.add_argument('--num_classes', type=int,
                    default=3, help='output channel of network') # 9
...
parser.add_argument('--cfg', type=str,  metavar="FILE",
                    default='./archs/swin_tiny_patch4_window7_224_lite.yaml', help='path to config file', )  # required=True,
parser.add_argument(
        "--opts",
